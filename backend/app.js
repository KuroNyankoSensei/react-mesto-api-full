...
app.use(cors({
  origin: [
    'https://mesto.kuronyanko.nomoredomains.sbs',
    'http://mesto.kuronyanko.nomoredomains.sbs',
    'https://api.mesto.kuronyanko.nomoredomains.sbs',
    'http://api.mesto.kuronyanko.nomoredomains.sbs',
    'https://www.api.mesto.kuronyanko.nomoredomains.sbs',
    'http://www.api.mesto.kuronyanko.nomoredomains.sbs',
    'http://localhost:3000',
